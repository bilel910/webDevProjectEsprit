...
<td>Author</td>
<td>CreateOn</td><td>Display</td>
<td>Update</td>
<td>Remove</td>
<td><button type="submit" value="submit" class="btn btn-success" name="sortasc">Sort(asc)</button></td>
<td><button type="submit" value="submit" class="btn btn-success" name="sortdsc">Sort(dsc)</button></td>
...
<tr> 
	...
	<button type="submit" value="submit" class="btn btn-success" name="edit_btn">Edit</button>	
    </form></td>
	<td> 
	<form action="template/Bookremove.php" method="post">
	<input type="hidden" name="remove_id" value="<?php echo $row['id']; ?>" style="color:black"/>
	<button type="submit" value="submit" class="btn btn-danger" name="remove_btn">Remove</button>	
    </form>
	</td>

	<td>
	<form action="template/display.php" method="post">
	<input type="hidden" name="display_id" value="<?php echo $row['id']; ?>" style="color:black"/>
	<button type="submit" value="submit" class="btn btn-success" name="display_btn">Display</button>	
    </form>
	</td>
	</tr>
<?php
...
<div class="text-center">
	 ...
	 <form action="template/Bookinsert.php" method="POST" enctype="multipart/form-data"> 
  ...
  <div class="form-group col-md-4">
    <label >Image</label>
 <p>upload Photo:&nbsp;&nbsp;<input type="file" name="photo" value=""> </p>
